...
.build/11-jail-test.js: ./src/test/jail-test.js
	cp src/test/jail-test.js .build/11-jail-test.js

lib/jail-test.js: .build/11-jail-test.js
	@mkdir -p ./lib/
	cp .build/11-jail-test.js $@
...
.PHONY : compile
compile: lib/armor.js lib/codejail.js lib/config.js lib/das.js lib/grader.js lib/profiles.js lib/server.js lib/test/codejail-test.js lib/test/server-test.js lib/codejail-test.js lib/server-test.js lib/jail-test.js index.js
...
.PHONY : clean-16
clean-16: 
	rm -rf .build/0-armor.js .build/1-codejail.js .build/2-config.js .build/3-das.js .build/4-grader.js .build/5-profiles.js .build/6-server.js .build/7-codejail-test.js .build/8-server-test.js lib/armor.js lib/codejail.js lib/config.js lib/das.js lib/grader.js lib/profiles.js lib/server.js lib/test/codejail-test.js lib/test/server-test.js .build/9-codejail-test.js .build/10-server-test.js lib/codejail-test.js lib/server-test.js .build/11-jail-test.js lib/jail-test.js .build/12-index.js index.js
